    ...
    return (
        <div
            ...
            <div className="w-72 mx-auto">
                <h1 className="relative bottom-5 md:text-left text-blue-500 text-4xl font-bold text-center">
                    About Me
                </h1>
                <p className="text-sm mt-2  md:text-left md:text-md text-gray-600 text-center dark:text-white md:w-72">
